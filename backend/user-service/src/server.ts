...
// Static assets cho avatar (support cả direct + qua gateway)
app.use('/uploads', express.static(storagePaths.avatars));
app.use('/users/uploads', express.static(storagePaths.avatars));
