...
export type RecommendationTypeEnum = 'meal' | 'exercise' | 'goal' | 'nutrition' | 'recipe';
export type PaymentStatusEnum = 'pending' | 'completed' | 'failed' | 'cancelled';
...
export type MealFilterParams = PaginationQuery & DateRangeQuery & {
  meal_type?: MealTypeEnum;
};

export type FoodFilterParams = PaginationQuery & SearchQuery & {
  is_vegetarian?: boolean;
  is_vegan?: boolean;
  is_gluten_free?: boolean;
  barcode?: string;
