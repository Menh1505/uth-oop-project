...
export function GoogleLoginButton({
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      console.log(
        "[GoogleLoginButton] Sending ID token to /api/auth/google-login"
      );
      const response = await ApiClient.post<any>("/auth/google-login", {
        idToken,
      });
      ...
      try {
        ...
        if (profileRes.ok) {
          ...
          console.log(
            "[GoogleLoginButton] Profile fetched:",
            profileData.needsOnboarding
          );
          // Pass profile data to success callback so onboarding status is known
          onSuccess?.({
            ...response,
            profile: profileData,
        ...
        console.warn(
          "[GoogleLoginButton] Could not fetch profile:",
          profileErr
        );
        // Still call success even if profile fetch fails
        onSuccess?.({
          ...response,
